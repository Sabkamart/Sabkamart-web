...
; (function ($) {
	...
	$.CookiesMessage = function (options) {
		...
		function inizialize(options) {
			...
			var displayMessage = `<div id="cookies"><div class="cookies-content"><p class="cookies-text">${options.messageText}</p><div class="cookies-actions"> ${partLinks}</div></div>${partClose}</div>`;
